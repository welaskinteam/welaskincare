...
const genderOptions = [
  {
    ...
    icon: (
      ...
      >
        ...
        <path
          fill="#47191f"
          d="M20 4v6h-2V7.425l-3.975 3.95q.475.7.725 1.488T15 14.5q0 2.3-1.6 3.9T9.5 20t-3.9-1.6T4 14.5t1.6-3.9T9.5 9q.825 0 1.625.237t1.475.738L16.575 6H14V4zM7.025 12.025Q6 13.05 6 14.5t1.025 2.475T9.5 18t2.475-1.025T13 14.5t-1.025-2.475T9.5 11t-2.475 1.025"
        />
      </svg>
    ),
  },
  {
    ...
    icon: (
      ...
      >
        ...
        <path
          fill="#47191f"
          d="M11 21v-2H9v-2h2v-2.1q-1.975-.35-3.238-1.888T6.5 9.45q0-2.275 1.613-3.862T12 4t3.888 1.588T17.5 9.45q0 2.025-1.263 3.563T13 14.9V17h2v2h-2v2zm3.475-9.025Q15.5 10.95 15.5 9.5t-1.025-2.475T12 6T9.525 7.025T8.5 9.5t1.025 2.475T12 13t2.475-1.025"
        />
      </svg>
    ),
  },
